...
namespace Faro.Entidades.ProgramTools
{
    public class ListaClientes
    {
        ...
        public static List<TcpClient> conectados;
        public ListaClientes() {

          conectados = new List<TcpClient>();

        }
        //SETTERS Y GETTERS 

        public static int cantidadEmp { get; set; }


        public void setConectados(List<TcpClient> n) {
        ...
        public List<TcpClient> getConectados() {

            return conectados;

        }
        public void pop() {
            int temp = 1 - conectados.Count;

            conectados.RemoveAt(temp);

        }

        public void Add(TcpClient n)
        {
